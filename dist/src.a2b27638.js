...
(function () {
  var utils = {
    make_element: function make_element() {
    ...
    add_classes: function add_classes(element, class_str) {
      var new_element = element.cloneNode();
      var class_arr = class_str.split(" ");
      class_arr.forEach(function (class_item) {
        return new_element.classList.add(class_item);
      });
      return new_element;
    },
    add_attributes: function add_attributes(element, attributes) {
      var new_element = element.cloneNode();
      var keys = Object.keys(attributes);
      keys.forEach(function (key) {
        return new_element.setAttribute(key, attributes[key]);
      });
      return new_element;
    },
    add_handlers: function add_handlers(element, handlers) {
      var new_element = element.cloneNode();
  ...
  var tn_guid = {
    ...
    refs: {},
    // Methods
    get_references: function get_references() {
    ...
    make_uuid: function make_uuid() {
      tn_guid.uuid_list.push((0, _v.default)());
    },
    // Components
  ...
  function init() {
    ...
    var button = tn_guid.create_button();
    tn_guid.refs.output.parentNode.insertBefore(button, tn_guid.refs.output);
  }

  window.addEventListener("load", init);
})();
},{"uuid/v4":"node_modules/uuid/v4.js","./main.scss":"src/main.scss"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "57599" + '/');
